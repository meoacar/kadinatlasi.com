...
@section('title', 'Yeni Ürün Oluştur')
...
<div class="space-y-6" x-data="productForm()">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Yeni Ürün Oluştur</h1>
            <p class="mt-1 text-sm text-gray-600">Yeni bir ürün ekleyin</p>
        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="description" name="description" rows="6"
                                  ...
                                  placeholder="Ürün açıklamasını girin">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="short_description" name="short_description" rows="3"
                                  ...
                                  placeholder="Kısa açıklama (opsiyonel)">{{ old('short_description') }}</textarea>
